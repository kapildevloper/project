<div class="row">
    ...
    ?>
        <div class="col-lg-4 col-md-6 col-12">
            <div class="single-blog-six style-2">
                ...
                <div class="blog-details">
                    ...
                    <a href="<?php the_permalink(); ?>" class="read-more-btn mt-15"><?php echo esc_html( $settings['read_more_txt'] ); ?> <i class="far fa-long-arrow-right"></i></a>
                    <?php endif; ?>
                </div>                        
            </div>                    
        </div>
