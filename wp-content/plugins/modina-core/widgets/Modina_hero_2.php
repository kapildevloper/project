...
class Modina_hero_2 extends Widget_Base {

    public function get_name() {
        return 'Modina_hero_2';
    }

    public function get_title() {
        return esc_html__( 'Hero 2 - Slider', 'modina-core' );
    }
    ...
    protected function register_controls() {
        ...
        $repeater->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::TEXTAREA,
                'label_block' => true,
                'default' => 'IT Software Solution And',
            ]
        );
        ...
        $repeater->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::TEXTAREA,
                'label_block' => true,
                'default' => 'We are 100+ professional software engineers with more than <br>
        ...
        $repeater->add_control(
            'button_text2',
            [
                'label' => esc_html__( 'Button Text - Video ', 'modina-core' ),
                'type' => Controls_Manager::TEXT,
                'label_block' => true,
                'default' => 'Watch How It Works',
            ]
        );
        ...
        $this->add_control(
            'color_subheading', [
                ...
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .single-slide .slide-contents h2' => 'color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_group_control(
            Group_Control_Typography::get_type(), [
                ...
                'selector' => '{{WRAPPER}} .single-slide .slide-contents h2',
            ]
        );
    ...
    include 'hero/hero-2.php';

    $dots = $settings['dots'] == 'yes' ? 'true' : 'false';
    $infinite = $settings['infinite'] == 'yes' ? 'true' : 'false';
    $autoplay = $settings['autoplay'] == 'yes' ? 'true' : 'false';
    $autoplaytimeout =  !empty($settings['autoplaytimeout']) ? $settings['autoplaytimeout'] : '2500';
    ?>
