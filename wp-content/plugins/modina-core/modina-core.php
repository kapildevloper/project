 ...
 * Description: This plugin adds the core features to the Quantech - IT Solutions and Web Agency WordPress Theme. This plugin is toolkit for theme. you must install it & active.
 * Version: 1.1
 * Author: Modina Theme
	...
	final class Modina_Core {
		...
		public function add_elementor_category() {
			...
			\Elementor\Plugin::instance()->elements_manager->add_category( 'modina-elements', [
				'title' => __( 'Transland Widgets', 'modina-core' ),
			], 1 );
		...
		private function include_widgets() {
			...
			require_once __DIR__ . '/widgets/Modina_video_hero.php';
			...
			require_once __DIR__ . '/widgets/Modina_testimonial_carousel.php';
			require_once __DIR__ . '/widgets/Modina_work_steps.php';
			require_once __DIR__ . '/widgets/Modina_service_card.php';
			require_once __DIR__ . '/widgets/Modina_service_icon.php';
			require_once __DIR__ . '/widgets/Modina_skillbar.php';
			require_once __DIR__ . '/widgets/Modina_features_carousel.php';
			require_once __DIR__ . '/widgets/Modina_project_showcase.php';
			require_once __DIR__ . '/widgets/Modina_portfolios.php';
			require_once __DIR__ . '/widgets/Modina_button.php';
			require_once __DIR__ . '/widgets/Modina_video_pop_button.php';
			require_once __DIR__ . '/widgets/Modina_hero_2.php';
			require_once __DIR__ . '/widgets/Modina_banner_hero.php';
        }
		...
		private function register_widgets() {
			...
			\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \ModinaCore\Widgets\Modina_video_hero() );
			...
			\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \ModinaCore\Widgets\Modina_work_steps() );
			...
			\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \ModinaCore\Widgets\Modina_features_carousel() );
			\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \ModinaCore\Widgets\Modina_testimonial_carousel() );
			\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \ModinaCore\Widgets\Modina_service_icon() );
			\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \ModinaCore\Widgets\Modina_project_showcase() );
			\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \ModinaCore\Widgets\Modina_portfolios() );
            \Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \ModinaCore\Widgets\Modina_button() );
            \Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \ModinaCore\Widgets\Modina_video_pop_button() );
            \Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \ModinaCore\Widgets\Modina_hero_2() );
            \Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \ModinaCore\Widgets\Modina_banner_hero() );
